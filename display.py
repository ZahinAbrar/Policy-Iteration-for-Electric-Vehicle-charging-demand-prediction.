...
def graphMicroGrid(batteryState, buyEnergy=[], sellEnergy=[], sampleTime=60, nowDayTime=None,
    ...
    axarr[0].set_title(title + 'Energy Demand', fontsize=fontSize)
    axarr[0].legend([ barD[0]], ['Demand'], loc=1)
    axarr[0].grid(axis='both', color='black', linestyle='-', linewidth=1, alpha=0.5)
    # MIDDLE battery state
    axarr[1].set_ylabel('Energy Units')
    axarr[1].set_title(title + ' Stored Battery Energy ', fontsize=fontSize)
    ...
    axarr[3].set_title("\n" + title + ' Buying Schedule From Grid', fontsize=fontSize)
